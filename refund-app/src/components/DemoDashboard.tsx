    ...
    return (
        <div className="w-full max-w-5xl relative z-10 animate-float mx-auto">
            <div className="rounded-[24px] border border-white/10 bg-[#050505] shadow-2xl overflow-hidden relative group">
                ...
                {/* Mock UI Container */}
                <div className="relative bg-[#0A0A0A] p-1 min-h-[500px] select-none">
                    <div className="bg-[#0f0f0f] rounded-[20px] overflow-hidden border border-white/5 h-full flex flex-col relative">

                        {/* --- SCREEN: LOGIN --- */}
                        {screen === "LOGIN" && (
                            <div className="absolute inset-0 flex items-center justify-center bg-[#0f0f0f] z-10 animate-in fade-in duration-500">
                        ...
                        {/* --- SCREEN: DASHBOARD --- */}
                        {screen === "DASHBOARD" && (
                            <div className="absolute inset-0 bg-[#0f0f0f] z-10 animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col">
                                {/* Nav */}
                        ...
                        {/* --- SCREEN: CREATE --- */}
                        {screen === "CREATE" && (
                            <div className="absolute inset-0 bg-[#0f0f0f] z-10 animate-in zoom-in-95 duration-300 flex flex-col">
                        ...
                        {screen === "DETAILS" && (
                            <div className="absolute inset-0 bg-[#0f0f0f] z-10 animate-in fade-in duration-500 flex flex-col">
