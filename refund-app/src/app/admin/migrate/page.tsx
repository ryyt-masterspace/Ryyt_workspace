...
import { AlertTriangle, CheckCircle2, ShieldCheck, Play, Save } from "lucide-react";

// TODO: Replace with the actual founder/admin email
const ADMIN_EMAIL = "shuva@example.com";
    ...
    if (!user || user.email !== ADMIN_EMAIL) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
                ...
                <p className="text-gray-600">This page is restricted to the Platform Founder only.</p>
            </div>
        );
    }
